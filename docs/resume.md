...
Technical writer and editor with a background in macOS systems engineering and enterprise IT. Experienced in developing user-focused documentation, administrator guides, knowledge base content, workflows, playbooks, and process documentation for internal teams and end users. Combines strong editing and documentation skills with hands-on expertise in macOS, endpoint management, JAMF Pro, and security-focused enterprise environments.
...
- Reviewed and edited the complete Calc 4.1, Draw 4.1, and Impress 4.1 user guides for clarity, consistency, usability, and technical accuracy.
...
- Apply editorial judgment to improve readability, consistency, and overall language performance.
...
- Wrote getting-started documentation for end users and process documentation for support and engineering teams.
