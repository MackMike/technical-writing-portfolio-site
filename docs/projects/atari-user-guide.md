...
|-------|-----------|-------------|------------------|
| <img src="../assets/pdfs/Atari-Computer-User-Guide/pictures/Amdek100.jpg" width="100" height="100" alt="Amdek Color Composite Monitor front view">   | Amdek Color Composite Monitor   | Display for sharp video.   | Composite cable from mod box.  |
